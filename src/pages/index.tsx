  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Social Networking - Your ultimate platform for connecting, sharing, and creating meaningful relationships in the digital world."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1519389950473-47ba0277781c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzb2NpYWwlMjBuZXR3b3JraW5nfGVufDB8fHx8MTY5MTgxMTY0MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Social Networking - Your ultimate platform for connecting, sharing, and creating meaningful relationships in the digital world.`}
            </Text>
            <Box
